...
description: Recria do zero o backend Java 21 + Spring Boot 4 (Spring for GraphQL, JPA/PostgreSQL, Spring Security, Spring AI) do sistema Markup, a partir de .claude/backend-markup, respeitando as 11 Rules. Use quando o usuário pedir para gerar/scaffoldar apenas o backend.
---
...
anexo · R11 guardas de cálculo e validação de entrada.
...
5. **Precificação** — `catalogo-calculos-validacoes` (fonte dos números) +
   ...
   guardas V1–V8, incluindo Fator R e anexo aplicado.
